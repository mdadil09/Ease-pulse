...
import { resetPassword, userLogin } from "@/api/api";
...
const ResetPassword = ({}: {
  ...
  const onSubmit = async (
    ...
    try {
      const data = await resetPassword(newPassword, userId, token);
  ...
  return (
    <div className="flex h-screen items-center justify-center">
      {!isSuccess ? (
        ...
        <ResetPasswordSucess handleLogin={handleLogin} path={userPath} />
      )}
    </div>
  );
};
